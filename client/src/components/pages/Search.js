    ...
    return (
        <div className="app__home">
                <Autocomplete
                    ...
                    label="Search for your favorite athletes in our database" variant="outlined" />}
                />
                <div className="button__container">
                    <Button style={{float: "right", marginRight: 15}} 
                    variant="contained" onClick={handleAddPlayer}>
                        Add Player
                    </Button>
                </div>
        </div>
