        ...
        <div className="stats_post">
            ...
            <ul className= "stats_list">
                ...
                <li className="stats_label"> Pts 
                    <p id={pointID} className="stats_line" > { stats[0] } </p>
                </li>
                <li className="stats_label"> Reb
                    <p id={rebID} className="stats_line"> { stats[1] } </p>
                </li>
                <li className="stats_label"> Stl
                    <p id={stlID} className="stats_line" > { stats[2] } </p>
                </li>
                <li className="stats_label"> Ast
                    <p id={astID} className="stats_line"> { stats[3] } </p>
                </li>
                <li className="stats_label"> Blk
                    <p id={blkID} className="stats_line"> { stats[4] } </p>
                </li>
